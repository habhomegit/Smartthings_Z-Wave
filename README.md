...
Note: The first time you open the device it will display calibrate even if you have manually calibrated. Use the value slider to calibrate position the blinds the first time.
