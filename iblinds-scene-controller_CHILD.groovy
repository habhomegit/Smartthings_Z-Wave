...
metadata {
	definition (name: "Child Button", namespace: "krlaframboise", author: "Kevin LaFramboise", ocfDeviceType: "x.com.st.d.remotecontroller") {
		capability "Button"
		capability "Sensor"
	}
...
def installed() {
	log.debug "installed()..."	
	sendEvent(name: "supportedButtonValues", value: ["pushed", "held"].encodeAsJSON())
